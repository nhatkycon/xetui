...
namespace linh.core.dal
{
    ...
    public sealed class SqlHelper
    {
        ...
        #region code by linhnx: linh_net@yahoo.com
        public static bool ValidColumn(IDataReader reader, string columnName)
        {
    ...
    public class DAL
    {
        ...
        {
            SqlConnection _con = new SqlConnection(ConfigurationManager.ConnectionStrings["conforum"].ConnectionString);
            return _con;
        }
    }
