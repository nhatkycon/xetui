...
namespace docsoft.entities
{
    ...
    public class Member : BaseEntity
    {
        ...
        public String VcardStr { get
        {
            ...
            //return SecondOnline == 0 ? string.Empty : string.Format(Vcard, SecondOnline);
            return Vcard;
        } 
        }
        public string Url
    ...
    public class MemberRedis
    {
        ...
        public List<Member> GetXacNhanItems(int start, int stop)
        {
            var ids = GetXacNhan().GetRange(start, stop).ToList();
        ...
        public Member GetByUsername(string username)
        {
            ...
            if (id == 0) return new Member();
            var item = GetById(id);
            return item;
        }
        public Member GetByRowId(Guid rowid)
        {
