...
[assembly: WebResource("appStore.commonStore.xuatNhapMgr.noiBoNhap.htm.htm", "text/html", PerformSubstitution = true)]
[assembly: WebResource("appStore.commonStore.xuatNhapMgr.noiBoNhap.DangKySanPhamDacTrung.htm", "text/html", PerformSubstitution = true)]
[assembly: WebResource("appStore.commonStore.xuatNhapMgr.noiBoNhap.DangKySanPhamMenu.htm", "text/html", PerformSubstitution = true)]
[assembly: WebResource("appStore.commonStore.xuatNhapMgr.noiBoNhap.DuyetSPDT.htm", "text/html", PerformSubstitution = true)]
[assembly: WebResource("appStore.commonStore.xuatNhapMgr.noiBoNhap.JScript1.js", "text/javascript", PerformSubstitution = true)]
namespace appStore.commonStore.xuatNhapMgr.noiBoNhap
{
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            switch (subAct)
            {
                case "get":
                    ...
                    var pagerGet = XuatNhapDal.pagerXuatNhap(false.ToString(), false.ToString(), true.ToString(),
                        false.ToString(), null,
                        jgrsidx + " " + jgrsord, _q,
                ...
                case "reports":
                    ...
                    if (!string.IsNullOrEmpty(ID))
                    {
                        ...
                        item.Ma = prefixMa + item.Ma;
                        item.XNCT = XuatNhapChiTietDal.SelectByXN_ID(item.ID.ToString());
                        var itemIn = Lib.GetResource(Assembly.GetExecutingAssembly(), "noiBoNhap.in.htm");
                        var itemInRow = Lib.GetResource(Assembly.GetExecutingAssembly(), "noiBoNhap.in-row.htm");
                ...
                case "scpt":
                    #region Nạp js
                    sb.AppendFormat(@"{0}"
                        , cs.GetWebResourceUrl(typeof(Class1), "appStore.commonStore.xuatNhapMgr.noiBoNhap.JScript1.js"));
                    //sb.AppendFormat(@"{0}"
                    //    , cs.GetWebResourceUrl(typeof(Class1), "appStore.commonStore.xuatNhapMgr.noiBoNhap.Publish.js"));
                    break;
                    #endregion
                default:
                    #region nạp
                    var listFn = FunctionDal.SelectByUserAndFNID(Security.Username, fnId);
                    sb.Append(Lib.GetResource(Assembly.GetExecutingAssembly(), "noiBoNhap.mdl.htm"));                    
                    sb.AppendFormat(@"<script>$.getScript('{0}',function(){1});</script>"
                        , cs.GetWebResourceUrl(typeof(Class1), "appStore.commonStore.xuatNhapMgr.noiBoNhap.JScript1.js")
                        , "{noiBoNhapFn.loadgrid();}");
