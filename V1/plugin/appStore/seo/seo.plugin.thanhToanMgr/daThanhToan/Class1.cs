...
[assembly: WebResource("seo.plugin.thanhToanMgr.daThanhToan.htm.htm", "text/html", PerformSubstitution = true)]
[assembly: WebResource("seo.plugin.thanhToanMgr.daThanhToan.JScript1.js", "text/javascript", PerformSubstitution = true)]

namespace seo.plugin.thanhToanMgr.daThanhToan
{
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            switch (subAct)
            {
                case "get":
                    ...
                    Pager<ThanhToan> PagerGet = ThanhToanDal.pagerdaThanhToan("T_" + jgrsidx + " " + jgrsord, Convert.ToInt32(jgRows));
                    foreach (ThanhToan item in PagerGet.List)
                    {
                        ListRow.Add(new jgridRow(item.ID.ToString(), 
                            ...
                            item.NgayChuyenTien.ToString("hh:mm dd/MM/yy")
                            }));
                    }
                ...
                case "scpt":
                    #region Nạp js
                    sb.AppendFormat(@"{0}"
                        , cs.GetWebResourceUrl(typeof(Class1), "seo.plugin.thanhToanMgr.daThanhToan.JScript1.js"));
                    break;
                    #endregion
                default:
                    #region nạp
                    ...
                    sb.Append(@"
<div class=""mdl-head"">
    <a class=""mdl-head-btn mdl-head-del"" id=""ThanhToanMgrdaThanhToan-daThanhToanBtn"" href=""javascript:;"" onclick=""ThanhToanMgrdaThanhToanFn.duyet(false);"">bỏ Duyệt</a>    
</div>
<table id=""ThanhToanMgrdaThanhToan-List"" class=""mdl-list""></table>
<div id=""ThanhToanMgrdaThanhToan-Pager""></div>
");
                    sb.AppendFormat(@"<script>$.getScript('{0}',function(){1});</script>"
                        , cs.GetWebResourceUrl(typeof(Class1), "seo.plugin.thanhToanMgr.daThanhToan.JScript1.js")
                        , "{ThanhToanMgrdaThanhToanFn.loadgrid();}");
