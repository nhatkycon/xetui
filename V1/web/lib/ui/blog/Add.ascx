...
<div class="padding-20 blog-add-pnl">
    ...
    <% switch (Item.Loai)
       {%>
    <%case 1: %>
        <a href="<%=MemberProfile.Url %>">
            <%=MemberProfile.Ten %>
        </a>&nbsp; &gt;
        <a href="<%=MemberProfile.Url %>/blogs/">
            Blog
        </a>
    <% break; %>
