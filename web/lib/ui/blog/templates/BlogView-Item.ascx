<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BlogView-Item.ascx.cs" Inherits="lib_ui_blog_templates_BlogView_Item" %>
<%@ Register TagPrefix="heThong" TagName="likeBtn" Src="~/lib/ui/HeThong/LikeBtn.ascx" %>
<%@ Import Namespace="docsoft" %>
<%@ Import Namespace="linh.common" %>
<div class="blog-view">
    <a title="/<%=Blog.MemberNguoiTao.Ten %>" href="/users/<%=Blog.NguoiTao %>/" class="blog-view-user">
        <img src="/lib/up/users/<%=Blog.MemberNguoiTao.Anh %>"/>
    </a>
    <div class="blog-view-content">
        ...
        <div class="blog-view-info">
            ...
            <div class="pull-right">
                <%if (Blog.NguoiTao == Security.Username)
                    { %>
